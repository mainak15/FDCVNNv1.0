...
def train_model(model, train_loader, val_loader, test_loader, criterion, optimizer, num_epochs,log_file_path):
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), './Saved_Model/MSTAR.pth')
    ...
    # Load the best model
    model.load_state_dict(torch.load('./Saved_Model/MSTAR.pth'))
    model.eval()
    all_labels = []
    all_preds = []
    correct = 0
...
train_path = './MSTAR1/train'
val_path = './MSTAR1/val'
test_path = './MSTAR1/test'
...
log_file = "MSTAR_10_soft_09_phase1_GOD_training_logs.csv"
