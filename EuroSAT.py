...
def train_model(model, train_loader, val_loader, test_loader, criterion, optimizer, num_epochs,log_file_path):
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), './Saved_Model/Eurosat.pth')
    ...
    model.load_state_dict(torch.load('./Saved_Model/Eurosat.pth'))
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = Complex_Hadamard_Layer(13, 64, kernel_size=64, apply_downsample=False)
        ...
        self.fc2 = Complex_Valued_Fully_Connected_Layer(512, 10)
...
log_file = "Eurosat_soft_09_3_phase_training_logs.csv"
